...
const DailyReplay = () => {
    ...
    const completionChartMax =
        Math.max(
            100,
            Math.ceil(
                highestCompletion / 25
            ) * 25
        );
    ...
    for (
        let value = 0;
        value <= completionChartMax;
        value += 25
    ) {
        completionTicks.push(value);
    }
        ...
        <main className="daily-replay-page">
            ...
            <section className="daily-replay-header">
                ...
                <div>
                    ...
                    <p>
                        Compare your plan with the time
                        you really spent.
                    </p>
                ...
                !error && (
                    <>
                        ...
                        <section className="replay-section">
                            ...
                            <div className="replay-chart-card completion-chart-card">
